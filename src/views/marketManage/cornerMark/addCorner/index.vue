 ...
 * @LastEditTime: 2021-03-23 17:14:22
 * @Descripttion: 
-->
<template>
	<div class="addSubScript">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
			...
			<el-form-item label="上传图片" prop="iconUrl" label-width="150px">
				<ImgUpload v-model.trim="ruleForm.iconUrl" :size="30" :ratio="1"></ImgUpload>
			</el-form-item>
...
import { addSubScript, getSubScriptInfo, editSubScript } from '@/api/subScript';
...
export default {
	...
	mounted() {
		// 编辑的时候获取角标详情
		if (this.id) {
			getSubScriptInfo({ id: this.id }).then(res => {
				if (res.success) {
