 ...
 * @LastEditTime: 2021-11-16 10:15:56
 * @Descripttion: 练习广告窗管理
-->
<template>
  <div class="toastModal">
    ...
    <!-- 表格 -->
    <Table :loadData="getList" ref="table" refHead="formListTop" :column="column" :showSortIndex="{ show: true, lable: '序号' }" :params="{ showLocation: 'TAB_11' }"></Table>
    <!-- 新增/编辑 -->
    ...
    return {
      ...
      column: [
        ...
        },
        {
          ...
          callback:()=>{
            console.log(this.formObjTop);
           return this.$refs.table.update(this.formObjTop)
          }
        },
  ...
  methods: {
    ...
    formButton(val) {
      if (val.name == "confirm" && val.valid) {
        let data = { ...this.ruleForm, ...val.value, };
